...
int main(int argc, char **argv)
{
    ...
    if(cipher_buffer(&output, &output_len, (unsigned char*)input, input_len, "/Users/vdrouin/mssis/mssis-tp/ssl_tls/rsa_pub.pem", "/Users/vdrouin/mssis/mssis-tp/ssl_tls/rsa.pem") == 0)
    {
        print_hex(output, output_len, "Encrypted text");
        if(uncipher_buffer(&unciphered, &unciphered_len, output, output_len, "/Users/vdrouin/mssis/mssis-tp/ssl_tls/rsa_pub.pem", "/Users/vdrouin/mssis/mssis-tp/ssl_tls/rsa.pem") == 0)
        {
